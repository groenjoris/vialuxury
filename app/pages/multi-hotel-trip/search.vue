...
// from useMultiHotelTripSearchState.
...
// Budget range — shared with /kaart via useMultiHotelTripSearchState so toggling between
...
function navigateToDeal(slug: string) {
  ...
  const url = `/multi-hotel-trip/deal/${slug}${qs ? '?' + qs : ''}`
