              ...
              >
                ...
                <div class="mrate__pricing">
                  <p class="mrate__prices">
                    <MultiHotelTripCheckoutPriceTag :value="rowWas(row)" :show-cents="false" size="sm" strike color="var(--c-medium-grey)" />
                    <MultiHotelTripCheckoutPriceTag :value="rowPrice(row)" :show-cents="false" size="lg" bold color="var(--c-via-orange)" />
