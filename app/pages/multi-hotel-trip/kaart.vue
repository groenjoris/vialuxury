...
import FilterPills from '~/components-multi-hotel-trip/search/FilterPills.vue'
import { isDealAvailable, isDealAvailableInWindow } from '~/utils-multi-hotel-trip/availability'
...
import HotelBrowseMap from '~/components-multi-hotel-trip/map/HotelBrowseMap.vue'
import HotelMapHoverCard from '~/components-multi-hotel-trip/map/HotelMapHoverCard.vue'
import HotelDealsSidePanel from '~/components-multi-hotel-trip/search/HotelDealsSidePanel.vue'
import HotelMapZoomControls from '~/components-multi-hotel-trip/map/HotelMapZoomControls.vue'
import SearchFilterPanel from '~/components-multi-hotel-trip/search/SearchFilterPanel.vue'
import HotelMapMobileCard from '~/components-multi-hotel-trip/map/HotelMapMobileCard.vue'
import FilterSubpage from '~/components-multi-hotel-trip/search/FilterSubpage.vue'
...
<template>
  <div class="kaart-page" :class="{ 'kaart-page--no-filter': !showFilter, 'kaart-page--mobile': isMobile }">
    ...
    <MultiHotelTripFilterPills v-if="!isMobile" class="kaart-pills" mode="map" />
    ...
    >
      ...
      <MultiHotelTripHotelMapHoverCard
      ...
      <MultiHotelTripHotelMapZoomControls
        v-if="!isMobile"
