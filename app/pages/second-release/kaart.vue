...
import { useSecondReleaseHotelMap } from '~/composables-second-release/useSecondReleaseHotelMap'
...
import { computeFilterCounts } from '~/utils-second-release/filterCounts'
import FilterPills from '~/components-second-release/search/FilterPills.vue'
import { isDealAvailable, isDealAvailableInWindow } from '~/utils-second-release/availability'
...
import HotelBrowseMap from '~/components-second-release/map/HotelBrowseMap.vue'
import HotelMapHoverCard from '~/components-second-release/map/HotelMapHoverCard.vue'
import HotelDealsSidePanel from '~/components-second-release/search/HotelDealsSidePanel.vue'
import HotelMapZoomControls from '~/components-second-release/map/HotelMapZoomControls.vue'
import SearchFilterPanel from '~/components-second-release/search/SearchFilterPanel.vue'
import HotelMapMobileCard from '~/components-second-release/map/HotelMapMobileCard.vue'
import FilterSubpage from '~/components-second-release/search/FilterSubpage.vue'
...
const mapHotels = computed<SearchHotel[]>(() => {
  ...
  const inBudget = (basePrice: number) => {
    const price = adjustPrice(basePrice, p, r)
...
const filterCounts = computed(() => {
  ...
  return computeFilterCounts({
    hotels: searchHotels,
    inBudget: (d) => {
      const price = adjustPrice(d.basePrice, p, r)
      return price >= sharedBudgetMin.value && price <= sharedBudgetMax.value
    },
...
<template>
  <div class="kaart-page" :class="{ 'kaart-page--no-filter': !showFilter, 'kaart-page--mobile': isMobile }">
    ...
    <SecondReleaseFilterPills v-if="!isMobile" class="kaart-pills" mode="map" />
    ...
    >
      ...
      <SecondReleaseHotelMapHoverCard
      ...
      <SecondReleaseHotelMapZoomControls
        v-if="!isMobile"
