<template>
  <div class="deal-page">
    <HuisstijlTopBar />
    <HuisstijlSiteHeader variant="solid" />
    ...
    <main v-if="hotel && currentDeal" class="deal-page__main">
      ...
      <section class="deal-page__breadcrumbs container">
        <HuisstijlBreadcrumbNav :items="breadcrumbs" />
      </section>
      ...
      <section class="deal-page__title-section container">
        <div class="deal-page__title-left">
          ...
          <div class="deal-page__hotel-name-wrap">
            <NuxtLink :to="`/huisstijl/hotel/${hotel.slug}`" class="deal-page__hotel-link">
      ...
      <section class="container deal-page__gallery">
        <HuisstijlHeroGallery :images="hotel.images" @open-gallery="openGallery" />
      ...
      <div class="deal-page__grid container">
        <div class="deal-page__col-left">
          ...
          <section v-if="isMobile" class="deal-page__mobile-faq">
            ...
            <HuisstijlFaqSection :faq-items="hotel.faq.slice(0, 3)" />
      ...
      <div v-if="!isMobile" id="tips">
        <HuisstijlHotelNearbyTips :tips="hotel.nearbyTips" :hotel-name="hotel.name" />
      </div>
    ...
    <HuisstijlTravelGroupModal />
    <HuisstijlPackageSidePanel
    ...
    <!-- Toast notification -->
    <HuisstijlToastNotification :message="toastMessage" type="success" />

    <!-- Auth popup -->
    <HuisstijlAuthPopup :is-open="isAuthPopupOpen" @close="isAuthPopupOpen = false" @login="handleLogin" />
    ...
    <HuisstijlMobileFullscreen :open="activeMobileSection === 'facilities'" :title="t('hotel.facilities')" @close="activeMobileSection = null">
    ...
    </HuisstijlMobileFullscreen>

    <HuisstijlMobileFullscreen :open="activeMobileSection === 'reviews'" :title="t('hotel.reviews')" @close="activeMobileSection = null">
    ...
    <HuisstijlMobileFullscreen :open="activeMobileSection === 'tips'" :title="t('hotel.nearbyTips') || 'Tips in de buurt'" @close="activeMobileSection = null">
      <div v-if="hotel" class="mobile-subpage mobile-subpage--no-padding">
        <HuisstijlHotelNearbyTips :tips="hotel.nearbyTips" :hotel-name="hotel.name" />
      </div>
    </HuisstijlMobileFullscreen>

    <HuisstijlMobileFullscreen :open="activeMobileSection === 'faq'" :title="t('hotel.faq') || 'Veelgestelde vragen'" @close="activeMobileSection = null">
      <div v-if="hotel" class="mobile-subpage">
        <HuisstijlFaqSection :faq-items="hotel.faq" />
      </div>
    </HuisstijlMobileFullscreen>
...
import { useHuisstijlDealStore } from '~/stores-huisstijl/deal'
import { formatPrice } from '~/utils-huisstijl/formatPrice'
import { getReviewLabelKey } from '~/utils-huisstijl/reviewLabel'
import { generateDealAvailability } from '~/data/mock/deal-pricing'
import { matchIcon } from '~/utils-huisstijl/iconMatcher'
import { nightsLabel, personsLabel, roomsLabel } from '~/utils-huisstijl/plural'
import {
...
const isMobile = useHuisstijlIsMobile()
...
const store = useHuisstijlDealStore()
...
const { searchVersion } = useHuisstijlSearchState()
...
const { partner } = useHuisstijlPartner()
...
const breadcrumbs = computed(() => [
  ...
  { label: t('search.arrangements'), href: '/huisstijl/search' },
