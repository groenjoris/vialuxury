<template>
  <div class="home home-v3">
    ...
    <HuisstijlSiteHeader ref="siteHeaderRef" variant="solid" hide-search-dock />
      ...
      <div class="container home-v3__hero-inner">
        ...
        <div class="home-v3__hero">
          <div class="home-v3__hero-left">
            ...
            <!-- Variant 4: Trustpilot block under the elevator pitch.
                 Logo on top, descriptive line below. -->
            <div class="home-v4__trust">
              <img src="/images/trustpilot.svg" alt="Trustpilot" class="home-v4__trust-logo" />
              <p class="home-v4__trust-text">15.294 gasten beoordelen ons met een 9 uit 10</p>
            </div>
          </div>
          <div class="home-v3__hero-photo">
            <span class="home-v3__hero-badge">
              <span class="home-v3__hero-badge-dot" aria-hidden="true" />
              Al meer dan 1 miljoen vakanties geboekt
            </span>
    ...
    <HuisstijlHomeVariantSwitcher current="4" />
  </div>
</template>

<script setup lang="ts">
import { POPULAR_FILTER_ICONS } from '~/utils-huisstijl/popularFilterIcons'
import { mappedHotels } from '~/data/deals-mapper'
import type { SearchHotel } from '~/types/searchHotel'
import { pickPrimaryDeal } from '~/utils-huisstijl/primaryDeal'
import { FILTER_TAGS, getFilterTag } from '~/utils-huisstijl/filterTags'
...
useHead({ title: 'ViaLuxury — Variant 4' })
</script>
...
/* ===== HERO + SEARCH SECTION =====
   Variant 4: 32px navbar→photo and 32px photo→search-bar; search-bar→
   assurance is half that (16px); below assurance also 16px so the
   assurance row sits with equal breathing room top and bottom. */
...
.home-v4__assurance {
  ...
  /* Hero-inner uses gap:32 between every child. Pull this row up by 16
     ...
     gaps). The padding below the section also sits at 16 → equal
