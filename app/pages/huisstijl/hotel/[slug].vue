  ...
  <div class="hotel-page">
    ...
    <main v-if="hotel" class="hotel-page__main">
      ...
      <section class="container">
        <HuisstijlHeroGallery :images="hotel.images" />
      </section>
      ...
      <section id="arrangementen" class="hotel-page__deals container">
        ...
        <div class="hotel-page__deals-search">
          <HuisstijlHotelSearchBar ref="searchBarRef" @search="handleSearchChange" />
        </div>
...
import DealCard from '~/components-huisstijl/search/DealCard.vue'

const { t, localized } = useHuisstijlI18n()
...
const { setSearchGroup, persons: globalPersons } = useHuisstijlSearchState()
