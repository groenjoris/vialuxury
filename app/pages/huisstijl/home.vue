<template>
  <div class="home">
    ...
    <section class="home-hero">
      ...
      <HuisstijlSiteHeader variant="overlay">
        <template #hero>
    ...
    <HuisstijlHomeVariantSwitcher current="1" />
  </div>
</template>
...
import { FILTER_TAGS } from '~/utils-huisstijl/filterTags'
...
const { toggleFilterTag, selectedFilterTags } = useHuisstijlSearchState()
