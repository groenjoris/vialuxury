      ...
      <div class="search-page__grid container" :class="{ 'search-page__grid--no-sidebar': !showFilters }">
        <Transition name="sidebar-slide">
          <div v-if="showFilters" class="search-page__sidebar">
            ...
            <HuisstijlMapPreviewCard class="search-page__map-preview" @click="handleMapClick" />
          ...
          <div class="search-page__header">
            <div class="search-page__header-row">
              <div>
                ...
                <HuisstijlFilterPills class="search-page__pills" />
              </div>
...
import { isDealAvailableInWindow } from '~/utils-huisstijl/availability'
import { adjustPrice } from '~/utils-huisstijl/priceFormula'
import { hotelMatchesDestination, hasActiveDestinationFilter } from '~/utils-huisstijl/destinationMatch'
import { pickPrimaryDeal } from '~/utils-huisstijl/primaryDeal'
...
// Budget range — shared with /kaart via useHuisstijlSearchState so toggling between
...
function navigateToDeal(slug: string) {
  ...
  window.open(`/huisstijl/deal/${slug}${qs ? '?' + qs : ''}`, '_blank')
}
</script>
