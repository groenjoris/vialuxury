...
import { useHuisstijlHotelMap } from '~/composables-huisstijl/useHuisstijlHotelMap'
import { useHuisstijlHomeVariant } from '~/composables-huisstijl/useHuisstijlHomeVariant'
import { dealMatchesAllTags, getFilterTag } from '~/utils-huisstijl/filterTags'
import FilterPills from '~/components-huisstijl/search/FilterPills.vue'
import { isDealAvailable, isDealAvailableInWindow } from '~/utils-huisstijl/availability'
import { adjustPrice } from '~/utils-huisstijl/priceFormula'
import { CITY_COORDS, PROVINCE_COORDS } from '~/data/city-coordinates'
import type { SearchHotel } from '~/types/searchHotel'
import HotelBrowseMap from '~/components-huisstijl/map/HotelBrowseMap.vue'
import HotelMapHoverCard from '~/components-huisstijl/map/HotelMapHoverCard.vue'
import HotelDealsSidePanel from '~/components-huisstijl/search/HotelDealsSidePanel.vue'
import HotelMapZoomControls from '~/components-huisstijl/map/HotelMapZoomControls.vue'
import SearchFilterPanel from '~/components-huisstijl/search/SearchFilterPanel.vue'
...
<template>
  <div class="kaart-page">
    ...
    <HuisstijlFilterPills class="kaart-pills" mode="map" />

    <main class="kaart-stage" :class="{ 'kaart-stage--with-panel': !!selectedHotel }">
      <ClientOnly>
        <HuisstijlHotelBrowseMap ref="mapRef" :hotels="mapHotels" :initial-focus="initialFocus" />
      </ClientOnly>

      <HuisstijlHotelDealsSidePanel
    ...
    <div class="kaart-mobile-fallback">
      ...
      <NuxtLink to="/huisstijl/home">Terug naar home</NuxtLink>
    </div>
  </div>
</template>
