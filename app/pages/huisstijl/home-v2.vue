<template>
  <div class="home">
    ...
    <section class="home-hero">
      ...
      <HuisstijlSiteHeader ref="siteHeaderRef" variant="overlay" hide-search-dock>
        <template #hero>
    ...
    <HuisstijlHomeVariantSwitcher current="2" />
  </div>
</template>
...
// `useHuisstijlSearchState` exposes the raw selected filter-tag IDs, not a themes-only
