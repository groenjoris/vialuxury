  ...
  <div class="home">
    ...
    <section class="home-hero">
      <!-- <img> + object-fit for consistent cropping across browsers.
           Per-photo crop tweaks (shift-up / shift-up-400) move to
           `object-position` via the same modifier classes. -->
      <div
        class="home-hero__bg"
        :class="{
...
/* v4 default crop: pull the photo down ~200 px within the 708-px crop
   window (reveals more of the upper portion). object-position uses
   percentages — "120%" shifts the image so 20 % spills below. */
.home-hero__bg-img {
  position: absolute;
  inset: 0;
  width: 100%;
...
/* hotelexperiencepackages + seapackages (pills 2 & 3) shift UP —
   reveal more of the image's lower portion. */
