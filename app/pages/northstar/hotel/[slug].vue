  ...
  <div class="hotel-page">
    ...
    <main v-if="hotel" class="hotel-page__main">
      ...
      <section class="container">
        <NorthstarHeroGallery :images="hotel.images" />
      </section>
      ...
      <section id="arrangementen" class="hotel-page__deals container">
        ...
        <div class="hotel-page__deals-search">
          <NorthstarHotelSearchBar ref="searchBarRef" @search="handleSearchChange" />
        </div>
...
import NorthstarDealCard from '~/components-northstar/search/DealCard.vue'
...
const { setSearchGroup, persons: globalPersons } = useNorthstarSearchState()
const searchPersons = ref(globalPersons.value || 2)
const searchBarRef = ref<InstanceType<typeof import('~/components-northstar/hotel/HotelSearchBar.vue').default> | null>(null)
