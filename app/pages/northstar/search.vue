      ...
      <div class="search-page__grid container" :class="{ 'search-page__grid--no-sidebar': !showFilters }">
        <Transition name="sidebar-slide">
          <div v-if="showFilters" class="search-page__sidebar">
            ...
            <NorthstarMapPreviewCard class="search-page__map-preview" @click="handleMapClick" />
          ...
          <div class="search-page__header">
            <div class="search-page__header-row">
              <div>
                ...
                <NorthstarFilterPills class="search-page__pills" />
              </div>
...
import { isDealAvailableInWindow } from '~/utils-northstar/availability'
import { adjustPrice } from '~/utils-northstar/priceFormula'
import { hotelMatchesDestination, hasActiveDestinationFilter } from '~/utils-northstar/destinationMatch'
...
// Budget range — shared with /kaart via useNorthstarSearchState so toggling between
