...
import { dealMatchesAllTags, getFilterTag } from '~/utils-northstar/filterTags'
import NorthstarFilterPills from '~/components-northstar/search/FilterPills.vue'
import { isDealAvailable, isDealAvailableInWindow } from '~/utils-northstar/availability'
import { adjustPrice } from '~/utils-northstar/priceFormula'
import { CITY_COORDS, PROVINCE_COORDS } from '~/data/city-coordinates'
import type { SearchHotel } from '~/types/searchHotel'
import NorthstarHotelBrowseMap from '~/components-northstar/map/HotelBrowseMap.vue'
import NorthstarHotelMapHoverCard from '~/components-northstar/map/HotelMapHoverCard.vue'
import NorthstarHotelDealsSidePanel from '~/components-northstar/search/HotelDealsSidePanel.vue'
import NorthstarHotelMapZoomControls from '~/components-northstar/map/HotelMapZoomControls.vue'
import NorthstarSearchFilterPanel from '~/components-northstar/search/SearchFilterPanel.vue'
...
<template>
  <div class="kaart-page">
    ...
    <NorthstarFilterPills class="kaart-pills" mode="map" />

    <main class="kaart-stage" :class="{ 'kaart-stage--with-panel': !!selectedHotel }">
      <ClientOnly>
        <NorthstarHotelBrowseMap ref="mapRef" :hotels="mapHotels" :initial-focus="initialFocus" />
      </ClientOnly>

      <NorthstarHotelDealsSidePanel
