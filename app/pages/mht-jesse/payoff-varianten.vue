<template>
  <div class="payoff-page">
    <div class="payoff-page__intro container">
      <h1 class="payoff-page__title">Pay-off &amp; subtitel — 2 varianten (R1)</h1>
    ...
    >
      ...
      <div class="payoff-variant__frame">
        ...
        <!-- Replica of the upper part of /mht-jesse/search: breadcrumbs,
...
const breadcrumbs = [
  { label: 'Home', href: '/mht-jesse/home' },
  { label: 'Arrangementen', href: '/mht-jesse/search' },
]
