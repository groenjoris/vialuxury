...
// gedeelde state uit de room table ('mhtj-checkout-selection').
import { hotel, rooms as roomsData, dealName, pricing } from '~/data/mhtj-checkout/deal'
import { CHECKOUT_BOOKING_FEE } from '~/data/mhtj-checkout/pricing'
...
const selection = useState<SelRow[]>('mhtj-checkout-selection', () => [])
...
<template>
  <div class="mhtj-checkout page page--white">
    <MhtJesseCheckoutTopNav />

    <div class="page__stepper">
      <MhtJesseCheckoutStepper :active="3" />
    </div>
    ...
    <main class="page__main container">
      <div class="page__grid">
        <div class="col-form">
          ...
          <MhtJesseCheckoutGegevensForm :start-at="1" :cancel-block="cancelBlock" :can-undo-flex="flexAddedHere" @toggle-flex="toggleFlex" />

          <div class="col-form__cta col-form__cta--split">
            <NuxtLink class="btn-back t-body" to="/mht-jesse/checkout/kamers">← Terug naar kamers</NuxtLink>
            ...
            <template v-if="roomsSel > 0">
              ...
              <div class="side__details">
                ...
                <div v-for="row in selection" :key="`${row.baseId}-${row.rateKey}`" class="side__row side__row--room">
                  ...
                  <MhtJesseCheckoutPriceTag :value="row.quantity * row.price" :show-cents="false" size="sm" />
                </div>
                <div class="side__row">
              ...
              <div class="side__total">
                <div class="side__totalrow">
                  ...
                  <div class="side__totalprices">
                    <MhtJesseCheckoutPriceTag :value="wasTotal" size="sm" strike color="var(--c-medium-grey)" />
                    <MhtJesseCheckoutPriceTag :value="totalPrice" size="lg" bold color="var(--c-via-green)" />
                  </div>
                </div>
              ...
              <p class="side__saved">
                ...
                <MhtJesseCheckoutPriceTag :value="saved" :show-cents="false" size="sm" bold color="var(--c-via-orange)" />
