...
import { hotel, rooms as roomsData, dealName } from '~/data/mhtj-checkout/deal'
...
function onSidebarBook() {
  ...
  navigateTo('/mht-jesse/checkout/gegevens')
}
...
<template>
  <div class="mhtj-checkout page page--white">
    ...
    <div class="page__stepper">
      <MhtJesseCheckoutStepper :active="2" />
    </div>
    ...
    <main class="page__main container">
      ...
      <div class="page__grid">
        <div class="col-form">
          ...
          <MhtJesseCheckoutRoomTable
            ref="roomTableRef"
            :show-reserve="false"
            bottom-cta
            book-to="/mht-jesse/checkout/gegevens"
        ...
        <div class="col-summary">
          <aside ref="sideEl" class="card side" :style="{ top: `${sideTop}px` }">
            ...
            <NuxtLink class="side__link side__link--center t-body" to="/mht-jesse/checkout/datum">
              Verander data
            </NuxtLink>
