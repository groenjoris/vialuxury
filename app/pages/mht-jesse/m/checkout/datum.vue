...
// Op een telefoon stuurt de mhtj-mobile middleware hier automatisch naartoe.
import { CHECKOUT_NIGHTS } from '~/data/mhtj-checkout/pricing'
...
<template>
  <div class="mhtj-checkout mhtj-checkout--m">
    <div class="mpage">
      <MhtJesseCheckoutMobileHeader :step="1" />
      ...
      <main class="mpage__main">
        ...
        <div ref="ctaEl" class="mcta">
          <button
            ...
            @click="navigateTo('/mht-jesse/m/checkout/kamers')"
          >
...
/* Kalender exact als op de dealpagina: de variant-6 overrides uit
   mhtj-variant-6.css (mobiele waarden), R1-tokens hardcoded —
