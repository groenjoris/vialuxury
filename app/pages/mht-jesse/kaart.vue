...
import { matchesNightKeys } from '~/utils-mht-jesse/nights'
import { computed } from 'vue'
import { useRoute, useRouter } from 'vue-router'
import { searchHotels } from '~/data/mock/search-hotels'
import { useMhtJesseHotelMap } from '~/composables-mht-jesse/useMhtJesseHotelMap'
...
import { isDealAvailable, isDealAvailableInWindow } from '~/utils-mht-jesse/availability'
...
import HotelBrowseMap from '~/components-mht-jesse/map/HotelBrowseMap.vue'
import HotelMapHoverCard from '~/components-mht-jesse/map/HotelMapHoverCard.vue'
import HotelDealsSidePanel from '~/components-mht-jesse/search/HotelDealsSidePanel.vue'
import HotelMapZoomControls from '~/components-mht-jesse/map/HotelMapZoomControls.vue'
import SearchFilterPanel from '~/components-mht-jesse/search/SearchFilterPanel.vue'
import HotelMapMobileCard from '~/components-mht-jesse/map/HotelMapMobileCard.vue'
import FilterSubpage from '~/components-mht-jesse/search/FilterSubpage.vue'
import { useMhtJesseIsMobile } from '~/composables-mht-jesse/useMhtJesseIsMobile'
...
const { homeHref } = useMhtJesseHomeVariant()
...
<template>
  <div class="kaart-page" :class="{ 'kaart-page--no-filter': !showFilter, 'kaart-page--mobile': isMobile }">
    ...
    <MhtJesseFilterPills v-if="!isMobile" class="kaart-pills" mode="map" />
