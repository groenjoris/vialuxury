<!--
  Deprecated — use <FirstReleaseDealCard> instead. The deal-first refactor replaced this
    ...
    <div class="result-card__content">
      ...
      <div class="result-card__hotel-header">
        <div class="result-card__hotel-info">
          <NuxtLink :to="`/first-release/hotel/${hotel.slug}`" target="_blank" class="result-card__name-link" @click.stop>
        ...
        <div class="result-card__score-wrap">
          <FirstReleaseViaLuxuryScoreBadge :hotel="hotel" :all-hotels="mappedHotels" />
        </div>
      </div>
...
const singleDealHref = computed(() => {
  ...
  return `/first-release/deal/${isSingleDealLink.value}${q ? '?' + q : ''}`
})
</script>
