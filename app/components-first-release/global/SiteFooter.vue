    ...
    <div class="site-footer__inner container">
      ...
      <div class="footer-col">
        ...
        <ul class="footer-links">
          ...
          <li><NuxtLink to="/first-release/search?city=maastricht">Maastricht</NuxtLink></li>
          <li><NuxtLink to="/first-release/search?city=rotterdam">Rotterdam</NuxtLink></li>
          <li><NuxtLink to="/first-release/search?city=utrecht">Utrecht</NuxtLink></li>
