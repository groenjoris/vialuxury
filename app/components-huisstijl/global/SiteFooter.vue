  ...
  <footer class="site-footer">
    <div class="site-footer__inner container">
      ...
      <div class="footer-col">
        ...
        <ul class="footer-links">
          <li><NuxtLink to="/huisstijl/search?city=amsterdam">Amsterdam</NuxtLink></li>
          <li><NuxtLink to="/huisstijl/search?city=antwerpen">Antwerpen</NuxtLink></li>
          <li><NuxtLink to="/huisstijl/search?city=maastricht">Maastricht</NuxtLink></li>
          <li><NuxtLink to="/huisstijl/search?city=rotterdam">Rotterdam</NuxtLink></li>
          <li><NuxtLink to="/huisstijl/search?city=utrecht">Utrecht</NuxtLink></li>
          <li class="footer-links__divider"></li>
