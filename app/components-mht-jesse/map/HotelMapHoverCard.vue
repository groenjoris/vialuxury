...
import { dealHasScarcity, roomsLeftForDeal } from '~/utils-mht-jesse/scarcity'
...
const { arrivalDate: globalArrivalDate } = useMhtJesseSearchState()
const { selectHotel, setHover, scheduleHover, keepHover } = useMhtJesseHotelMap()
