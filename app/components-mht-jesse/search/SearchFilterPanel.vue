...
import { NIGHT_GROUPS, nightGroupState, toggleNightGroup, type NightGroup } from '~/utils-mht-jesse/nights'
...
/* Reisduur in twee groepen (zie utils-mht-jesse/nights.ts). */
