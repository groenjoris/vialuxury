...
// (MhtJesse) en deze bestandsnaam — de component heet daardoor
// <MhtJesseTripQuickFilters> (niet MhtJesseTripQuickFilters).
import { TRIP_QUICK_FILTERS } from '~/utils-mht-jesse/tripFilters'
...
const { selectedTripFilters, toggleTripFilter } = useMhtJesseSearchState()
