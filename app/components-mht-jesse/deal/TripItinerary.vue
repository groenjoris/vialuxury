    ...
    <section v-for="day in days" :key="day.day" class="itin-day">
      <header class="itin-day__head">
        ...
        <p v-if="day.subtitle" class="itin-day__subtitle">
          <MhtJesseTripHotelText :text="day.subtitle" :hotels="hotels" @open-hotel="$emit('open-hotel', $event)" />
        </p>
      </header>
        ...
        >
          ...
          <div class="itin-block__body">
            <h4 class="itin-block__title">
              <MhtJesseTripHotelText :text="block.title" :hotels="hotels" @open-hotel="$emit('open-hotel', $event)" />
