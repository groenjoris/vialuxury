  ...
  <footer class="site-footer">
    <div class="site-footer__inner container">
      ...
      <div class="footer-col">
        ...
        <ul class="footer-links">
          <li><NuxtLink to="/second-release/search?city=amsterdam">Amsterdam</NuxtLink></li>
          <li><NuxtLink to="/second-release/search?city=antwerpen">Antwerpen</NuxtLink></li>
          <li><NuxtLink to="/second-release/search?city=maastricht">Maastricht</NuxtLink></li>
          <li><NuxtLink to="/second-release/search?city=rotterdam">Rotterdam</NuxtLink></li>
          <li><NuxtLink to="/second-release/search?city=utrecht">Utrecht</NuxtLink></li>
...
const { homeHref } = useSecondReleaseHomeVariant()

// Prototype toggle for the deal page's "Samengesteld door" card.
const { showCreatorCard, setShowCreatorCard, restoreShowCreatorCard } = useSecondReleaseCreatorCard()
