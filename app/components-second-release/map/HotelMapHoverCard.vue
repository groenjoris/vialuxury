...
import { dealHasScarcity, roomsLeftForDeal } from '~/utils-second-release/scarcity'
...
const { arrivalDate: globalArrivalDate } = useSecondReleaseSearchState()
const { selectHotel, setHover, scheduleHover, keepHover } = useSecondReleaseHotelMap()
