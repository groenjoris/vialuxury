<template>
  <div class="mini-map">
    <NuxtLink
      :to="`/second-release/kaart?focus=${slug}`"
      class="mini-map__placeholder"
      :aria-label="t('common.viewMap')"
    >
      <SecondReleaseStaticMiniMap :lat="lat" :lng="lng" :zoom="zoom" />
    ...
    <div class="mini-map__footer">
      ...
      <NuxtLink :to="`/second-release/kaart?focus=${slug}`" class="mini-map__view-link">
        {{ t('common.viewMap') }}
      </NuxtLink>
    </div>
  </div>
