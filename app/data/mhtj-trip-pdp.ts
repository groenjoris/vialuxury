 ...
 * die de dealpagina (/mht-jesse/deal/[slug]) verwacht, zodat de
...
import { tripDetailBySlug, type MhtJesseDetail, type MhtJesseDetailStop } from './mhtj-trips'
import { TRIP_ITINERARIES, type TripItinerarySpec } from './mhtj-trip-itineraries'
...
function dinnerOf(stop: MhtJesseDetailStop): { label: LocalizedString; daily: boolean } | null {
...
export function buildTripDays(trip: MhtJesseDetail, content: TripItinerarySpec | null): TripRawDay[] {
...
export function tripHotelDetails(trip: MhtJesseDetail, content: TripItinerarySpec | null, stopIndex: number): TripHotelDetails | null {
...
function buildImages(trip: MhtJesseDetail): { images: HotelImage[]; stickers: Record<string, string> } {
...
function buildDeal(trip: MhtJesseDetail): Deal {
  return {
    id: `${trip.id}-deal`,
    hotelSlug: trip.slug,
    nights: trip.nights,
...
function buildHotel(trip: MhtJesseDetail, images: HotelImage[], content: TripItinerarySpec | null): Hotel {
...
export function tripPdpBySlug(slug: string): MhtJessePdp | null {
