...
export const TRIP_ITINERARIES: Record<string, TripItinerarySpec> = {
  ...
  'trip-fietsvakantie-twente-salland': {
    ...
    mapHighlights: [
      { name: l('Landgoed Twickel', 'Twickel Estate'), lat: 52.276, lng: 6.718, text: l('Kasteel, watermolen en oude eiken op een van de mooiste landgoederen van Nederland.', 'Castle, watermill and ancient oaks on one of the finest estates in the Netherlands.'), image: '/images/vakanties/007/twickel-kasteel.jpg' },
      { name: l('Zoutmuseum Delden', 'Salt Museum Delden'), lat: 52.263, lng: 6.709, text: l('Klein museum over de zoutwinning in Twente, midden in Delden.', 'Small museum on salt mining in Twente, in the centre of Delden.'), image: '/images/vakanties/007/nearby-twickel.jpg' },
      { name: l('Holterberg', 'Holterberg'), lat: 52.305, lng: 6.425, text: l('Uitkijktoren op de Sallandse Heuvelrug, halverwege de etappe naar Raalte.', 'Lookout tower on the Sallandse Heuvelrug, halfway along the leg to Raalte.'), image: '/images/vakanties/007/nearby-heuvelrug.jpg' },
      { name: l('Deventer', 'Deventer'), lat: 52.252, lng: 6.16, text: l('Hanzestad met de Brink, het Bergkwartier en het voetveer over de IJssel.', 'Hanseatic town with the Brink, the Bergkwartier and the foot ferry across the IJssel.'), image: '/images/vakanties/007/nearby-deventer-brug.jpg' },
      { name: l('Kastelen rond Diepenheim', 'Castles around Diepenheim'), lat: 52.199, lng: 6.534, text: l('Nijenhuis, Weldam, Warmelo en Huis Diepenheim op één fietsrondje.', 'Nijenhuis, Weldam, Warmelo and Huis Diepenheim on a single cycling loop.'), image: '/images/vakanties/007/nearby-fietsers-stad.jpg' },
      { name: l('Goor', 'Goor'), lat: 52.232, lng: 6.585, text: l('Het stedeke Goor, onderweg op de kastelenroute.', 'The little town of Goor, on the castle route.'), image: '/images/vakanties/007/kaart-lezen.jpg' },
    ],
  },
}
