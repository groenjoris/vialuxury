...
import { priceForArrival, minRoomsFor, maxRoomsFor } from '~/utils-huisstijl/priceFormula'
import dayjs from 'dayjs'

export const useHuisstijlDealStore = defineStore('huisstijl-deal', () => {
  ...
  // useHuisstijlSearchState so every calendar on the site (navbar DatePopup, hotel
