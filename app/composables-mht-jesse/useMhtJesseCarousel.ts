...
export interface UseMhtJesseCarouselOptions {
 ...
 *   const { activeIndex, goTo } = useMhtJesseCarousel(images, { enabled: isMultiRoom })
 */
export function useMhtJesseCarousel<T>(
  items: Ref<T[]> | ComputedRef<T[]>,
  options: UseMhtJesseCarouselOptions = {},
) {
