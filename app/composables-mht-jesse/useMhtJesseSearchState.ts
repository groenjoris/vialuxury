 ...
 *     5/6/7/8 als losse categorieën, zie utils-mht-jesse/nights.ts)
...
const SS_TRIP_FILTERS = 'vl_mhtj_trip_filters'
 ...
 *  (zie utils-mht-jesse/tripFilters.ts). */
...
export function useMhtJesseSearchState() {
