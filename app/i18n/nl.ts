const nl: Record<string, string> = {
  ...
  'header.anyDurationLabel': 'Elke reisduur',
  'header.duration.noMatter': 'Maakt niet uit',
  'header.duration.5plusLong': '5 nachten of meer',
  // Multi Hotel Trip — reisduur 5/6/7/8 als losse categorieën
  'header.duration.5nightsExact': '5 nachten',
  'header.duration.6nights': '6 nachten',
  'header.duration.7nights': '7 nachten',
  'header.duration.8nights': '8 nachten',
  ...
  'footer.promoTerms': 'Actievoorwaarden',
  'footer.allRightsReserved': 'Alle rechten voorbehouden.',
  'footer.newsletterTitle': 'Wordt gratis lid en ontvang €10 korting',
  'footer.newsletterPlaceholder': 'E-mailadres',
  'footer.newsletterCta': 'Ontvang code',
  ...
  'trip.itin.collapseAll': 'Alles inklappen',
  'trip.itin.type.arrival': 'Aankomst',
  'trip.itin.type.transfer': 'Reisdag',
  'trip.itin.type.stay': 'Verblijf',
  'trip.itin.type.home': 'Terugreis',
  'trip.itin.head.arrival': 'Aankomst in {city}',
  'trip.itin.head.transfer': '{from} → {to}',
  'trip.itin.head.stay': 'Een dag in en rond {city}',
  'trip.itin.head.home': 'Terug naar huis',
  'trip.itin.stop': 'Stop {n} van {total}',
  'trip.itin.viewHotel': 'Bekijk hotel',
  'trip.itin.viewMap': 'Bekijk grote kaart',
  'trip.itin.fromPrev': '{distance} vanaf {city}',
  'trip.itin.overview': '{days} dagen · {hotels} hotels',
  'trip.itin.stats.days': '{n} dagen',
  ...
  'trip.itin.city.breakfastText': 'Ontbijt zit erbij: elke ochtend staat een uitgebreid ontbijtbuffet voor je klaar.',
  'trip.itin.city.alsoIncluded': 'Ook inbegrepen: {items}.',
  'trip.itin.city.and': ' en ',
  'trip.itin.city.outings': 'Leuke uitjes in de buurt',
  'trip.itin.city.outingsIntro': 'Drie tips voor tijdens je verblijf — klik voor het hele verhaal.',
  'trip.itin.city.prev': 'Vorige uitjes',
  'trip.itin.city.next': 'Volgende uitjes',
  ...
  'trip.bike.arrivalLine': 'Heenreis: ca. {duration} met de auto vanuit {city}',
  ...
  'trip.tag.route': 'Onderweg',
  'trip.tag.activity': 'Ontdekken',
  'trip.tag.dinner': 'Diner',
  'trip.tag.homeward': 'Terugreis',
  'trip.checkinAt': 'Inchecken bij {hotel}',
  'trip.checkoutAt': 'Uitchecken bij {hotel}',
  'trip.checkoutText': 'Na het ontbijt check je uit bij {hotel}. De volgende etappe is kort, dus er is alle tijd voor een tussenstop onderweg.',
  'trip.dinnerAt': '{dinner} bij {hotel}',
  ...
  'trip.subtitle.home': 'Uitchecken bij {hotel} en terugreis naar huis.',
  'trip.distanceDrive': '{km} km ({duration})',
  'trip.distanceBike': '{km} km fietsen',
  'trip.dur.halfHour': 'een half uur',
  'trip.dur.threeQuarters': 'drie kwartier',
  'trip.dur.hour': 'een uur',
  ...
  'filter.5days': '5 nachten',
  'filter.6days': '6 nachten',
  'filter.7days': '7 nachten',
  'filter.8days': '8 nachten',
  ...
  'hotel.readMore': 'Lees meer',
  'hotel.showAvailableDeals': 'Toon beschikbare arrangementen',
  ...
  'deal.viewOtherArrangements': 'Bekijk overige arrangementen bij dit hotel',
  'deal.otherArrangements': 'Overige arrangementen',
  'deal.availableArrangements': 'Beschikbare arrangementen:',
  ...
  'hotel.availableDeals': 'Beschikbare arrangementen bij dit hotel.',
  'hotel.availableDealsSubtitle': 'Unieke experiences, met liefde samengesteld door het ViaLuxury team',
  ...
  'deal.houseRulesIntro': 'De volgende informatie is van toepassing op het hotel dat hoort bij dit arrangement.',
