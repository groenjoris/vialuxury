const en: Record<string, string> = {
  ...
  'header.anyDurationLabel': 'Any duration',
  'header.duration.noMatter': "Doesn't matter",
  'header.duration.5plusLong': '5 nights or more',
  'header.duration.5nightsExact': '5 nights',
  'header.duration.6nights': '6 nights',
  'header.duration.7nights': '7 nights',
  'header.duration.8nights': '8 nights',
  ...
  'footer.promoTerms': 'Promotion Terms',
  'footer.allRightsReserved': 'All rights reserved.',
  'footer.newsletterTitle': 'Become a free member and get €10 off',
  'footer.newsletterPlaceholder': 'Email address',
  'footer.newsletterCta': 'Get code',
  ...
  'search.hotelDeal': 'hotel package',
  'search.hotelDeals': 'hotel packages',
  ...
  'trip.daySingle': 'Day {a}',
  'trip.dayAnd': 'Day {a} and {b}',
  'trip.dayRange': 'Day {a} to {b}',
  ...
  'trip.itin.expandAll': 'Expand all',
  'trip.itin.collapseAll': 'Collapse all',
  'trip.itin.type.arrival': 'Arrival',
  'trip.itin.type.transfer': 'Travel day',
  'trip.itin.type.stay': 'Stay',
  'trip.itin.type.home': 'Homeward',
  'trip.itin.head.arrival': 'Arrival in {city}',
  'trip.itin.head.transfer': '{from} → {to}',
  'trip.itin.head.stay': 'A day in and around {city}',
  'trip.itin.head.home': 'Back home',
  'trip.itin.stop': 'Stop {n} of {total}',
  'trip.itin.viewHotel': 'View hotel',
  'trip.itin.viewMap': 'View large map',
  'trip.itin.fromPrev': '{distance} from {city}',
  'trip.itin.overview': '{days} days · {hotels} hotels',
  ...
  'trip.itin.city.breakfastText': 'Breakfast is included: an extensive breakfast buffet awaits you every morning.',
  'trip.itin.city.alsoIncluded': 'Also included: {items}.',
  'trip.itin.city.and': ' and ',
  'trip.itin.city.outings': 'Fun things to do nearby',
  'trip.itin.city.outingsIntro': 'Three tips for your stay — click for the full story.',
  'trip.itin.city.prev': 'Previous outings',
  'trip.itin.city.next': 'Next outings',
  ...
  'trip.bike.timeLine': '{min} to {max} hours of cycling per leg, at a relaxed pace',
  'trip.bike.arrivalLine': 'Getting there: approx. {duration} by car from {city}',
  ...
  'trip.tag.route': 'En route',
  'trip.tag.activity': 'Explore',
  'trip.tag.dinner': 'Dinner',
  'trip.tag.homeward': 'Journey home',
  'trip.checkinAt': 'Check in at {hotel}',
  'trip.checkoutAt': 'Check out at {hotel}',
  'trip.checkoutText': 'After breakfast you check out at {hotel}. The next leg is short, so there is plenty of time for a stop along the way.',
  'trip.dinnerAt': '{dinner} at {hotel}',
  ...
  'trip.subtitle.home': 'Check out at {hotel} and journey home.',
  'trip.distanceDrive': '{km} km ({duration})',
  'trip.distanceBike': '{km} km by bike',
  'trip.dur.halfHour': 'half an hour',
  'trip.dur.threeQuarters': 'three quarters of an hour',
  'trip.dur.hour': 'an hour',
  ...
  'filter.5days': '5 nights',
  'filter.6days': '6 nights',
  'filter.7days': '7 nights',
  'filter.8days': '8 nights',
  ...
  'deal.otherArrangements': 'Other arrangements',
