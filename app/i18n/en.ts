const en: Record<string, string> = {
  ...
  'trip.bike.luggageLine': 'Your luggage goes ahead; you cycle with just the cycling bag',
  'trip.bike.arrivalLine': 'Getting there: approx. {duration} by car from {city}, free parking at the starting hotel',
  'trip.bike.arrivalLineTrain': 'Getting there: approx. {duration} by car from {city} (free parking), or by train to {station} station',
  'trip.bike.rentalLine': 'Your own bike or a rental bike/e-bike, bookable as an extra',
