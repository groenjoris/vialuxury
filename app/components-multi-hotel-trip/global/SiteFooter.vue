  ...
  <footer class="site-footer">
    <div class="site-footer__inner container">
      ...
      <div class="footer-col">
        ...
        <ul class="footer-links">
          <li><NuxtLink to="/multi-hotel-trip/search?city=amsterdam">Amsterdam</NuxtLink></li>
          <li><NuxtLink to="/multi-hotel-trip/search?city=antwerpen">Antwerpen</NuxtLink></li>
          <li><NuxtLink to="/multi-hotel-trip/search?city=maastricht">Maastricht</NuxtLink></li>
          <li><NuxtLink to="/multi-hotel-trip/search?city=rotterdam">Rotterdam</NuxtLink></li>
          <li><NuxtLink to="/multi-hotel-trip/search?city=utrecht">Utrecht</NuxtLink></li>
...
const { showCreatorCard, setShowCreatorCard, restoreShowCreatorCard } = useMultiHotelTripCreatorCard()
