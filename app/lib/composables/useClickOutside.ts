 ...
 *
 * @param target A single element ref, or an array of element refs.
 * @param handler Called with the originating MouseEvent on an outside click.
 *
 * @example
 *   const dropdownEl = ref<HTMLElement | null>(null)
 *   useClickOutside(dropdownEl, () => isOpen.value = false)
 */
