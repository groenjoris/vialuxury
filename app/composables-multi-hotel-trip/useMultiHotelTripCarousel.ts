...
export interface UseMultiHotelTripCarouselOptions {
 ...
 *   const { activeIndex, goTo } = useMultiHotelTripCarousel(images, { enabled: isMultiRoom })
 */
export function useMultiHotelTripCarousel<T>(
  items: Ref<T[]> | ComputedRef<T[]>,
  options: UseMultiHotelTripCarouselOptions = {},
) {
