 ...
 */
export type TripQuickFilterGroup = 'transport' | 'land' | 'thema'
...
export const TRIP_QUICK_FILTERS: TripQuickFilter[] = [
  ...
  { id: 'nieuw', label: 'Nieuw', group: 'thema' },
  ...
  { id: 'ontspanning', label: 'Ontspanning', group: 'thema' },
  { id: 'cultuur', label: 'Cultuur', group: 'thema' },
]
