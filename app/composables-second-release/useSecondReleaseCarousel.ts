...
export interface UseSecondReleaseCarouselOptions {
 ...
 *   const { activeIndex, goTo } = useSecondReleaseCarousel(images, { enabled: isMultiRoom })
 */
export function useSecondReleaseCarousel<T>(
  items: Ref<T[]> | ComputedRef<T[]>,
  options: UseSecondReleaseCarouselOptions = {},
) {
