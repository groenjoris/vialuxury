 ...
 */
const SS_ARRIVAL = 'vl_ns_arrival_date'
const SS_FLEX = 'vl_ns_arrival_flex'
const SS_PERSONS = 'vl_ns_search_persons'
const SS_ROOMS = 'vl_ns_search_rooms'
const SS_DESTINATIONS = 'vl_ns_destinations'
const SS_CITIES = 'vl_ns_cities'
const SS_HOTELS = 'vl_ns_hotels'
const SS_SELECTION_ORDER = 'vl_ns_selection_order'
const SS_NIGHTS = 'vl_ns_selected_nights'
const SS_FLEX_TYPE = 'vl_ns_flex_type'
...
export function useNorthstarSearchState() {
