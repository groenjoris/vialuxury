...
import { priceForArrival, minRoomsFor, maxRoomsFor, PRICED_PERSONS } from '~/utils-multi-hotel-trip/priceFormula'
import dayjs from 'dayjs'

export const useMultiHotelTripDealStore = defineStore('multi-hotel-trip-deal', () => {
  ...
  // useMultiHotelTripSearchState so every calendar on the site (navbar DatePopup, hotel
