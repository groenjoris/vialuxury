...
export interface UseFirstReleaseCarouselOptions {
 ...
 *   const { activeIndex, goTo } = useFirstReleaseCarousel(images, { enabled: isMultiRoom })
 */
export function useFirstReleaseCarousel<T>(
  items: Ref<T[]> | ComputedRef<T[]>,
  options: UseFirstReleaseCarouselOptions = {},
) {
