...
export interface UseHuisstijlCarouselOptions {
 ...
 *   const { activeIndex, goTo } = useHuisstijlCarousel(images, { enabled: isMultiRoom })
 */
export function useHuisstijlCarousel<T>(
  items: Ref<T[]> | ComputedRef<T[]>,
  options: UseHuisstijlCarouselOptions = {},
) {
