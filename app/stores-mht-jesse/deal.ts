...
import { priceForArrival, minRoomsFor, maxRoomsFor, PRICED_PERSONS } from '~/utils-mht-jesse/priceFormula'
import dayjs from 'dayjs'

export const useMhtJesseDealStore = defineStore('mht-jesse-deal', () => {
  ...
  // useMhtJesseSearchState so every calendar on the site (navbar DatePopup, hotel
